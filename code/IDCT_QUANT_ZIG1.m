%version 3.1
function B = IDCT_QUANT_ZIG1(A, row, col)
    ...
    for temp1 = 1 : block_y
        for temp2 = 1 : block_x
            ...
            blocks{temp1,temp2} = bitand(int8(blocks{temp1,temp2}),1);%write back the LSB
        end
    end

    %directly return the LSB of the blocks, without de Quantify and iDCT 
    B = blocks;
end
